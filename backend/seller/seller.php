                                        ...
                                        <?php
                                            foreach($seller_data as $data){
                                                ...
                                                <div class = "row">
                                                    <div class = "col-md-6">
                                                <?php
                                                echo "<button onclick = 'get_detail(" . $data["id"]. ")' class = 'btn btn-success'>顯示</button>";
                                                ?>
                                                    </div>
                                                    <div class = "col-md-6">
                                                <?php
                                                echo "<button onclick = 'delete_seller(".$data["id"].")' value = ".$data["id"]." class = 'btn btn-danger'>刪除</button>";
                                                ?>
                                                    </div>
                                                </div>
                                                <?php
